...
# 46 "MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 96 "MCAL_Layer/GPIO/../mcal_std_types.h"
...
volatile uint8 *tric_registers[] = {&TRISA, &TRISB, &TRISC, &TRISD, &TRISE};
...
Std_ReturnType gpio_pin_direction_initialize(const pin_config_t *pin_config){
    ...
    if ((pin_config == ((void*)0)) || (pin_config->pin > 8 - 1)){
        ...
        switch (pin_config->direction){
            case GPIO_OUTPUT:
                (*(tric_registers[pin_config->port]) &= ~((uint8)1 << pin_config->pin));
...
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t *pin_config, direction_t *direction_status){
    ...
    if ((pin_config == ((void*)0)) || (direction_status == ((void*)0)) || (pin_config->pin > 8 - 1)){
        ...
        *direction_status = ((*(tric_registers[pin_config->port]) >> pin_config->pin) & (uint8)1);
        ret = (Std_ReturnType)0x01;
    }

    return ret;
}
# 81 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_write_logic(const pin_config_t *pin_config, logic_t logic){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    ...
    if ((pin_config == ((void*)0)) || (pin_config->pin > 8 - 1)){
        ...
        switch (logic){
            case GPIO_LOW:
                (*(lat_registers[pin_config->port]) &= ~((uint8)1 << pin_config->pin));
                ret = (Std_ReturnType)0x01;
                break;
            case GPIO_HIGH:
                (*(lat_registers[pin_config->port]) |= ((uint8)1 << pin_config->pin));
...
Std_ReturnType gpio_pin_read_logic(const pin_config_t *pin_config, logic_t *logic){
    ...
    if ((pin_config == ((void*)0)) || (logic == ((void*)0)) || (pin_config->pin > 8 - 1)){
        ...
        *logic = ((*(port_registers[pin_config->port]) >> pin_config->pin) & (uint8)1);
        ret = (Std_ReturnType)0x01;
    }

    return ret;
}
# 139 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_toggle_logic(const pin_config_t *pin_config){
    Std_ReturnType ret = (Std_ReturnType)0x00;
...
# 162 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_initialize(const pin_config_t *pin_config){
    Std_ReturnType ret = (Std_ReturnType)0x00;
...
# 211 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_get_direction_initialize(port_index_t port_index, uint8 *direction_status){
    Std_ReturnType ret = (Std_ReturnType)0x00;

    if ((direction_status == ((void*)0)) || (port_index > 5 - 1)){
        ret = (Std_ReturnType)0x00;
    }
    else{
...
# 259 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_read_logic(port_index_t port_index, uint8 *logic){
    Std_ReturnType ret = (Std_ReturnType)0x00;

    if ((logic == ((void*)0)) || (port_index > 5 - 1)){
        ret = (Std_ReturnType)0x00;
    }
    else{
...
# 282 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_toggle_logic(port_index_t port_index){
    Std_ReturnType ret = (Std_ReturnType)0x00;

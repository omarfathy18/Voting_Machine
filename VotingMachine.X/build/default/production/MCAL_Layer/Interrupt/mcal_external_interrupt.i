    ...
    if (int_obj == ((void*)0)){
        ...
        switch(int_obj->source){
            case INTERRUPT_INT0:
                ...
                break;
            case INTERRUPT_INT1:
# 275 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
                ...
                break;
            case INTERRUPT_INT2:
# 291 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
...
# 369 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
static Std_ReturnType interrupt_INTx_edge_init(const interrupt_INTx_t *int_obj){
    Std_ReturnType ret = (Std_ReturnType)0x00;
